#
#  Be sure to run `pod spec lint KUniMPSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                   this static lib for KKLiao program, it's static lib come from UniMPSDK
                   DESC

  spec.homepage     = "https://github.com/meterlisence/KUniMPSDK"
  ...
  spec.author             = { "meterlisence" => "meterlisence@gmail.com" }
  # Or just: spec.author    = "meterlisence"
  # spec.authors            = { "meterlisence" => "meterlisence@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/meterlisence"
  ...
  spec.source       = { :git => "https://github.com/meterlisence/KUniMPSDK.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "KUniMPSDK", "KUniMPSDK/**/*.{h}"
